...
class USBank:
    ...
    def filter_by_dev_location(self):
        try:
            ...
            time.sleep(5)
            search_btn.click()
            location_btn = WebDriverWait(self.driver, 10).until(EC.presence_of_element_located((By.CLASS_NAME, 'css-shvw01')))
            location_btn.click()
            time.sleep(7)
            location_usa = WebDriverWait(self.driver, 10).until(EC.presence_of_element_located((By.XPATH, '//input[@id="bc33aa3152ec42d4995f4791a106ed09"]')))
            location_usa.click()
            time.sleep(5)
